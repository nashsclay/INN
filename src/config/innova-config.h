/* src/config/innova-config.h.  Generated from innova-config.h.in by configure.  */
/* src/config/innova-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef INNOVA_CONFIG_H

#define INNOVA_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/innovacoin/innova/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Innova Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Innova Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "innovacore"
