...
{
    if(fLiteMode) return; // ignore all Innova related functionality
...
/*
    ...
    allow endless transaction that would bloat Innova and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("innova-privatesend");
